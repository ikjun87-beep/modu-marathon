...
- [ ] **10차 APK 빌드 트리거됨**(2026-07-12, ID `978669c5-ea5c-4cce-b1a2-83e9753c4fcf`, preview) — P7-2 부드러움 + 5탭 IA(홈·랭킹·마이) 통합. 로그 https://expo.dev/accounts/jjunshot/projects/modu-marathon/builds/978669c5-ea5c-4cce-b1a2-83e9753c4fcf . 완료 후 회장 재설치 → 5탭 전환·홈 큐레이션·랭킹·마이·배지·처리방침링크 확인 → 만족 시 main 머지.
- [ ] **P7-6(후행)**: 통합 검색.
