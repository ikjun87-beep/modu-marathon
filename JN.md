...
- [ ] **11차 APK 빌드 트리거됨**(2026-07-12, ID `1129ba31-a1a4-4b89-9d8e-640819ecdc74`, preview) — Pine Green + 데모데이터 + 댓글 + 글수정 포함. 로그 https://expo.dev/accounts/jjunshot/projects/modu-marathon/builds/1129ba31-a1a4-4b89-9d8e-640819ecdc74 . 완료 후 회장 재설치 → ①전체 그린 톤 ②5탭이 여러 크루원 데이터로 채워짐 ③러닝 상세 댓글 작성 ④방명록 본인 글 수정 확인.
