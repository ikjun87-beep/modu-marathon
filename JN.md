...
- [ ] **10차 실기기 확인**(회장): ①하단 5탭(홈·크루·러닝·랭킹·마이) 전환 ②홈 Today 큐레이션(오늘/이번주·크루합계·다가오는 모임) ③홈 검색(크루·러닝·모임) ④랭킹(메달·월100K 진행바) ⑤마이(이름수정·통계·배지·처리방침 링크). 만족 시 `feat/p7-2-shared-motion`→main 머지.
