...
- [ ] **10차 APK 빌드**(재트리거, ID `0234cf91-8d28-4b26-9a97-7d9a142107cd`, preview) — **P7-2 부드러움 + 5탭 IA + 통합 검색 전부 포함**. (앞선 `978669c5`는 검색 전 빌드라 취소·대체.) 로그 https://expo.dev/accounts/jjunshot/projects/modu-marathon/builds/0234cf91-8d28-4b26-9a97-7d9a142107cd . 완료 후 회장 재설치 → 5탭 전환·홈 큐레이션·검색·랭킹·마이·배지·처리방침링크 확인 → 만족 시 `feat/p7-2-shared-motion`→main 머지.
