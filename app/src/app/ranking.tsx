                    ...
                    return (
                      <View key={r.name} style={styles.podCol}>
                        ...
                        {/* ⚠️ 시상대는 목록 행과 **다른 규칙**이어야 한다.
                            ...
                            → **한 줄 고정 + 글자만 줄여 담는다**.
                            ⚠️ 최소 75%(≈9.7px)로 뒀더니 19자가 다 보이는 대신 **1등 이름이
                            2·3위보다 작아져 위계가 뒤집혔다**(실기기 확인) — 시상대의 목적은
                            "누가 1등인지 한눈에"라서 안 읽히면 실패다. **85%(≈11px)로 올린다**:
                            아주 긴 이름은 말줄임이 조금 남지만 읽히는 크기를 지킨다.
                            **풀네임은 4위 이하 목록(3줄)이 책임진다** — 역할을 나눈다. */}
                        <Text
